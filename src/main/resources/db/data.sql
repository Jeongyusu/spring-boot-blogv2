...
insert into board_tb(title, content, user_id, created_at) values('제목11', '내용2', 1, now());
insert into board_tb(title, content, user_id, created_at) values('제목111', '내용2', 1, now());
insert into board_tb(title, content, user_id, created_at) values('제목1111', '내용2', 1, now());
